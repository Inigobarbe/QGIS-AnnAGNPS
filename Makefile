...
SOURCES = \
	__init__.py \
	ephemeral_gully.py ephemeral_gully_dialog.py

PLUGINNAME = ephemeral_gully

PY_FILES = \
	__init__.py \
	ephemeral_gully.py ephemeral_gully_dialog.py

UI_FILES = ephemeral_gully_dialog_base.ui
...
QGISDIR=C:\Users\inigo.barberena\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
