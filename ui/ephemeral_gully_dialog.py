...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'ephemeral_gully_dialog_base.ui'))


class EphemeralGullyDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(EphemeralGullyDialog, self).__init__(parent)
